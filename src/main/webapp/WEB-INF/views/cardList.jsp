...
#cardGrid{
  ...
  gap:50px 40px;justify-items:center;max-width:1200px;margin:0 auto;
}
.item{
  width:220px;text-align:center;cursor:pointer;         /* ← 클릭 가능 커서 */
}
...
#searchInput{
  width:260px;padding:8px 35px;font-size:15px;border:2px solid #000;
...
#advKeyword{
  width:100%;padding:8px 12px;margin-bottom:15px;box-sizing:border-box;
...
.adv-close{
  position:absolute;top:15px;right:20px;font-size:22px;font-weight:700;cursor:pointer;
}
</style>
</head>
<body>
